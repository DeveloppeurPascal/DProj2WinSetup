...
[Buy a license](https://store.olfsoftware.fr/en/developer-software-c-3/delphi-development-c-4/dproj-to-windows-setup-p-3)
...
If you detect any anomalies on earlier versions, please don't hesitate to [report them](https://github.com/DeveloppeurPascal/DProj2WinSetup/issues) so that I can test and try to correct or provide a workaround.
